...
export default class PolicyList extends React.Component {
  ...
  render () {
    ...
    return (
      <div>
        <label><input type="radio" defaultChecked name="policyTypeRadio" onClick={() => this.showHomePolicies()}/> Show
          Home Policies</label>
        <br/>
        <label><input type="radio" name="policyTypeRadio" onClick={() => this.showAutoPolicies()}/> Show Auto
          Policies</label>
        <h3>Policies: </h3>
